...
public class AdapterPosts extends RecyclerView.Adapter<com.example.tripshare.AdapterPosts.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, final int position) {
        ...
        holder.like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(holder.itemView.getContext(), PostsLikedByActivity.class);
